...
class ImportUpstream(LogDedentMixin, GitMixin):
    ...
    def _apply(self, commit_list, base=None, interactive=False, resume_cmdline=None):
        if base is None:
    ...
    def resume(self, strategy, interactive=False, cmdline=None):
        ...
        self._apply(commit_list, base, interactive)
